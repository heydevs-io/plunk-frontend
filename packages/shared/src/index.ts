...
const id = z
  .string({
    invalid_type_error: "ID needs to be a string",
...
const zodSchema = z.record(
  z.union(
    [
      ...
      z.object(
        {
          persistent: z
            .boolean({ invalid_type_error: "Persistent should be a boolean" })
            .optional()
            .default(true),
  ...
  {
    invalid_type_error:
      "Metadata should be an object (https://docs.useplunk.com/working-with-contacts/metadata)",
  }
);
