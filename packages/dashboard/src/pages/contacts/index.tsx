        ...
        return (
          <>
            ...
            >
              ...
              <div className="flex justify-between flex-1 gap-1 sm:justify-end">
                {page > 1 && (
                  <button
          ...
          <div className={"grid sm:col-span-2"}>
            ...
            {fields.length > 0 ? (
              fields.map((field, index) => {
                return (
                  <div key={field.id}>
                    <div className="grid items-end w-full grid-cols-9 gap-3">
          ...
          actions={
            <div className="flex gap-3">
              <input
                ...
                className="transition ease-in-out rounded border-neutral-300 focus:border-neutral-800 focus:ring-neutral-800 sm:text-sm"
              />
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="flex items-center justify-center px-8 py-2 text-sm font-medium text-center text-white rounded gap-x-1 bg-neutral-800"
              >
