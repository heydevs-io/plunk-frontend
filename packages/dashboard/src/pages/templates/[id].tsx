...
export default function Index() {
  ...
  const {
    ...
    setError,
    clearErrors,
  } = useZodForm(TemplateSchemas.update, {
    defaultValues: {
      body: undefined,
    },
  });
  ...
  const update: FirstParams<typeof handleSubmit> = (data) => {
    toast.promise(
      network.mock<Template, typeof TemplateSchemas.update>(
        ...
        "/v1/templates",
        {
          // @ts-expect-error: `id` is not explicitly defined in `template` with any type
          id: template.id,
          ...data,
        }
      ),
